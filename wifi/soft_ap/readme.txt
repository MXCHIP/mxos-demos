/**
  ...
  * @file        softap/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.4.x
  * @date    11-April-2016
  * @brief   Description of the  "wifi_softap"  demo.
  ******************************************************************************


 @par Demo Description 
This demo shows:  how to config device working as softap mode.



@par Directory contents 
    - Demos/wifi/softap/wifi_softap.c   Soft access point demo
    - Demos/wifi/softap/mxos_config.h   MiCO function header file
