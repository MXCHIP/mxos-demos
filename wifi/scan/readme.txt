/**
  ...
  * @file    scan/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.4.0
  * @date    11-April-2016
  * @brief   Description of the  "wifi_scan"  demo.
  ******************************************************************************


@par Demo Description 
This demo shows:  how to scan the available wifi network and print list to log.


@par Directory contents 
    - Demos/wifi/wifi_sacn.c     Wi-Fi scan demo program
    - Demos/wifi/mxos_config.h   MiCO function header file
