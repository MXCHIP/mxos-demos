/**
  ...
  * @file    Check Algorithm/SHA/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.4.x 
  * @date    2016-2-1
  * @brief   Description of the  "SHA"  demo.
  ******************************************************************************

  @par Demo Description 
This demo shows:  
    - how to use SHA based on MiCO SDK. 
 

@par Directory contents 
    - \include\mxos_security.h    Declaration of SHA API   
    - MicoCrypto.a                Defination of  SHA API 
