/**
  ...
  * @file    Security Algorithm/RSA/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.4.x 
  * @date    2016-2-1
  * @brief   Description of the  "RSA"  demo.
  ******************************************************************************

  @par Demo Description 
This demo shows:  
    - how to use RSA a based on MiCO SDK. 
 

@par Directory contents 
    - \include\mxos_security.h    Declaration of RSA API   
