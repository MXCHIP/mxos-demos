/**
  ...
  * @file    Check Algorithm/CRC8/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.4.x 
  * @date    2016-2-1
  * @brief   Description of the  "CRC8"  demo.
  ******************************************************************************

  @par Demo Description 
This demo shows:  
    - how to use CRC8 based on MiCO SDK. 
 

@par Directory contents 


    - libraries\utilities\CheckSumUtils.h    Declaration of CRC8 API   
    - libraries\utilities\CheckSumUtils.c    Defination of  CRC8 API 
