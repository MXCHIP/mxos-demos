/**
  ...
  * @file    Check Algorithm/MD5/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.4.x 
  * @date    2016-2-1
  * @brief   Description of the  "MD5"  demo.
  ******************************************************************************

  @par Demo Description 
This demo shows:  
    - how to use MD5 a based on MiCO SDK. 
 

@par Directory contents 
    - \include\mxos_security.h    Declaration of MD5 API   
    - MicoCrypto.a                Defination of  MD5 API 
