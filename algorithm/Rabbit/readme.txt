/**
  ...
  * @file    Security Algorithm/Rabbit/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.4.x 
  * @date    2016-2-1
  * @brief   Description of the  "Rabbit"  demo.
  ******************************************************************************

  @par Demo Description 
This demo shows:  
    - how to use Rabbit a based on MiCO SDK. 
 

@par Directory contents 
    - \include\mxos_security.h    Declaration of Rabbit API   
