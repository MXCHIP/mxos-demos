/**
  ...
  * @file    Security Algorithm/ARC4/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.4.x 
  * @date    2016-2-1
  * @brief   Description of the  "ARC4"  demo.
  ******************************************************************************

  @par Demo Description 
This demo shows:  
    - how to use ARC4 a based on MiCO SDK. 
 

@par Directory contents 
    - \include\mxos_security.h    Declaration of ARC4 API   
