/**
  ...
  * @file    Security Algorithm/DES/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.4.x 
  * @date    2016-2-1
  * @brief   Description of the  "DES"  demo.
  ******************************************************************************

  @par Demo Description 
This demo shows:  
    - how to use DES a based on MiCO SDK. 
 

@par Directory contents 
    - \include\mxos_security.h    Declaration of DES API   
