/**
  ...
  * @version v2.4.x 
  * @date    17-May-2019
  * @brief   Description of the  "spi test"  demo.
  ******************************************************************************

  @par Demo Description 
This demo shows:  
    - how to use spi based on a spi test applicaiton program. 
...
@par Directory contents 
    - Demos/test/spi_test/spi_test.c      Applicaiton program
    - Demos/test/spi_test/mxos_config.h   MXOS function header file
